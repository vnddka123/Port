namespace Support.Util
{
    ...
    public static class Extensions
    {
        ...
        public static bool IsHeroType(this Obj_AI_Base obj, HeroType type)
        {
            ...
            {
                case HeroType.Ad:
                    return obj.IsValid<AIHeroClient>() && Ad.Contains(obj.CharData.BaseSkinName.ToLowerInvariant());

                case HeroType.Ap:
                    return obj.IsValid<AIHeroClient>() && Ap.Contains(obj.CharData.BaseSkinName.ToLowerInvariant());

                case HeroType.Bruiser:
                    return obj.IsValid<AIHeroClient>() && Bruiser.Contains(obj.CharData.BaseSkinName.ToLowerInvariant());

                case HeroType.Support:
                    return obj.IsValid<AIHeroClient>() && Sup.Contains(obj.CharData.BaseSkinName.ToLowerInvariant());

                case HeroType.Tank:
                    return obj.IsValid<AIHeroClient>() && Tank.Contains(obj.CharData.BaseSkinName.ToLowerInvariant());
            }
