...
namespace Fresh_TahmKench
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.Write(e);
                Chat.Print("FreshTahmKench is not working. plz send message by KorFresh (Code 2)");
            }
        }
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                {
                    Chat.Print("No Support Champion");
                    return;
                }
            ...
            {
                Console.Write(e);
                Chat.Print("FreshTahmKench is not working. plz send message by KorFresh (Code 3)");
            }
        }
        ...
        private static void OnGameUpdate(EventArgs args)
        {
            ...
            {
                Console.Write(e);
                //Chat.Print("FreshTahmKench is not working. plz send message by KorFresh (Code 4)");
            }
        }
        ...
        private static void AntiGapcloser_OnEnemyGapcloser(ActiveGapcloser gapcloser)
        {
            ...
            {
                Console.Write(e);
                Chat.Print("FreshTahmKench is not working. plz send message by KorFresh (Code 6)");
            }
        }
        ...
        private static void OnProcessSpell(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            try
            {
                if (!sender.IsMe && sender.IsEnemy)
                {
                    ...
                    {
                        var EndPosition = ObjectManager.Get<AIHeroClient>().OrderBy(x => x.Health).FirstOrDefault(x => x.IsAlly && !x.IsMe && !x.IsDead && !x.IsZombie
            ...
            {
                Console.Write(e);
                Chat.Print("FreshTahmKench is not working. plz send message by KorFresh (Code 7)");
            }
        }
