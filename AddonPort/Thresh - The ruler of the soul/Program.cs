...
namespace ThreshTherulerofthesoul
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Interrupter2.OnInterruptableTarget += new Interrupter2.InterruptableTargetHandler(Interrupter2_OnInterruptableTarget);
            Obj_AI_Base.OnPlayAnimation += new Obj_AI_BasePlayAnimation(Obj_AI_Base_OnPlayAnimation);
            EscapeBlocker.OnDetectEscape += new EscapeDetector(EscapeBlocker_OnDetectEscape);
        }
                        ...
                        case 0:
                            {
                                ...
                                if (b.Hitchance >= HitChance.High && Player.Distance(target.ServerPosition) < Q.Range)
                                {
                                    Q.Cast(target);
                                }
                            }
