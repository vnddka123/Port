...
namespace BrianSharp.Plugin
{
    internal class Udyr : Helper
    {
        ...
        private static void Fight()
        {
            ...
            if (GetValue<bool>("Combo", "E") && E.IsReady() && CanCastE(target) && E.Cast())
            {
                return;
            }
            ...
            {
                if (GetValue<bool>("Combo", "Q") && Q.Cast())
                {
                    return;
                }
        ...
        {
            SmiteMob();
            //var obj = Orbwalking.GetPossibleTarget;
            //if (obj == null)
            {
            //    return;
            }
            if (GetValue<bool>("Clear", "Q") && Q.Cast())
            {
                return;
            }
        ...
        {
            if (!GetValue<bool>("Flee", "E") || E.Cast() || !GetValue<bool>("Flee", "Stack"))
            {
                return;
            }
        ...
        private static void StunCycle()
        {
            ...
            if (Orbwalking.InAutoAttackRange(obj))
            {
                EloBuddy.Player.IssueOrder(GameObjectOrder.AttackUnit, obj);
            }
            else
            {
                EloBuddy.Player.IssueOrder(GameObjectOrder.MoveTo, obj.ServerPosition);
            }
        }
