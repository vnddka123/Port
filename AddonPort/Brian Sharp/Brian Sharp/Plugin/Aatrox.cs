    ...
    internal class Aatrox : Helper
    {
        ...
        private static void Fight(string mode)
        {
            if (GetValue<bool>(mode, "Q") &&
                ...
                Q2.CastOnBestTarget(Q2.Width / 2, true).IsCasted())
            {
                return;
            }
            if (GetValue<bool>(mode, "E") && E.CastOnBestTarget(0, true).IsCasted())
            {
                return;
            }
            if (mode != "Combo")
        ...
        private static void Clear()
        {
            ...
            if (GetValue<bool>("Clear", "Q") && Q.IsReady())
            {
                ...
                else
                {
                    ...
                    if (obj != null && Q.IsInRange(obj, Q.Range + Q2.Width / 2) && Q.Cast(obj).IsCasted())
                    {
                        return;
                    }
                }
        ...
        {
            if (GetValue<bool>("Flee", "Q") && Q.IsReady() && Q.Cast(Game.CursorPos))
            {
                return;
            }
        ...
        private static void KillSteal()
        {
            ...
            if (GetValue<bool>("KillSteal", "Q") && Q.IsReady())
            {
                ...
                if (target != null && Q.IsKillable(target) && Q2.Cast(target).IsCasted())
                {
                    return;
                }
            }
