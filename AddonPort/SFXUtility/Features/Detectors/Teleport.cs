...
namespace SFXUtility.Features.Detectors
{
    internal class Teleport : Child<Detectors>
    {
        ...
        protected override void OnEnable()
        {
            ...
            EloBuddy.SDK.Events.Teleport.OnTeleport += OnTeleport;
            ...
            try
            {
                ...
                if (teleport != null)
                {
                    ...
                    if (args.Status == TeleportStatus.Abort)
                    {
                        ...
                        {
                            Chat.Print(string.Format("<font color='#CC0000'>Aborted: {0}</font>", teleport.Hero.ChampionName));
                        }
                    }
        ...
        //*/
        private void OnTeleport(Obj_AI_Base sender, EloBuddy.SDK.Events.Teleport.TeleportEventArgs args)
        {
            try
            {
                //var packet = Packet.S2C.Teleport.Decoded(sender, args);
