...
namespace OneKeyToWin_AIO_Sebby.Champions
{
    class Tristana
    {
        ...
        private void Game_OnUpdate(EventArgs args)
        {
            ...
            {
                var eTarget = HeroManager.Enemies.FirstOrDefault(target => target.LSIsValidTarget() && LeagueSharp.Common.Orbwalking.InAutoAttackRange(target) && target.HasBuff("tristanaechargesound"));
                if(eTarget != null)
                {
