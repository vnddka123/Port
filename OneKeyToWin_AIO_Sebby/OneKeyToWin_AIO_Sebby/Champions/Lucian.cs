    ...
    class Lucian
    {
      ...
      //          return;
        ...
        private void Game_OnGameUpdate(EventArgs args)
        {
            ...
            {
                var t = EloBuddy.SDK.TargetSelector.GetTarget(R.Range, DamageType.Physical);
        ...
        private void LogicQ()
        {
            var t = LeagueSharp.Common.TargetSelector.GetTarget(Q.Range, LeagueSharp.Common.TargetSelector.DamageType.Physical);
            var t1 = LeagueSharp.Common.TargetSelector.GetTarget(Q1.Range, LeagueSharp.Common.TargetSelector.DamageType.Physical);
            ...
            else if ((Program.Farm || Program.Combo) && Config.Item("harasQ", true).GetValue<bool>() && t1.LSIsValidTarget(Q1.Range) && Config.Item("harras" + t1.ChampionName).GetValue<bool>() && Player.LSDistance(t1.ServerPosition) > Q.Range + 100)
            {
                ...
                if (!OktwCommon.CanHarras())
                    return;
                var prepos = LeagueSharp.Common.Prediction.GetPrediction(t1, Q1.Delay);
        ...
        private void LogicR()
        {
            ...
            if (t.LSIsValidTarget(R.Range) && t.LSCountAlliesInRange(500) == 0 && OktwCommon.ValidUlt(t) && !LeagueSharp.Common.Orbwalking.InAutoAttackRange(t))
            {
