...
namespace OneKeyToWin_AIO_Sebby.Champions
{
    class Varus
    {
        ...
        private void LogicQ()
        {
            ...
            else if (Program.LaneClear && getCheckBoxItem(farmMenu, "farmQ") && Player.Mana > RMANA + QMANA + WMANA && Q.Range > 1500 && Player.CountEnemiesInRange(1450) == 0 && (Q.IsCharging || (Player.ManaPercentage() > getSliderItem(farmMenu, "Mana"))))
            {
