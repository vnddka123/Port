...
namespace OneKeyToWin_AIO_Sebby.Core
{
    static class PredictionAio
    {
        ...
        internal static void CCast(this LeagueSharp.Common.Spell spell, Obj_AI_Base target, HitChance SelectedHitchance) //for Circular spells
        {
        ...
        internal static void LCast(this LeagueSharp.Common.Spell spell, Obj_AI_Base target, HitChance SelectedHitchance, float alpha = 0f, float colmini = float.MaxValue, bool HeroOnly = false, float BombRadius = 0f) //for Linar spells  사용예시 AIO_Func.LCast(Q,Qtarget,50,0)  
        ...
        internal static void ConeCast(this LeagueSharp.Common.Spell spell, Obj_AI_Base target, HitChance SelectedHitchance, float alpha = 0f, float colmini = float.MaxValue, bool HeroOnly = false)
        {
        ...
        internal static void AOECast(this LeagueSharp.Common.Spell spell, Obj_AI_Base target)
        {
            if (spell != null && target != null)
            {
