...
namespace Viktor
{
    internal class Program
    {
        ...
        private const int ECastRange = 525;
...
//            UpdateChecker.Init("Apollo16", "Viktor");
        ...
        private static void OnUpdate(EventArgs args)
        {
            ...
            if (R.Instance.Name != "ViktorChaosStorm" && Menu.Item("AutoFollowR").GetValue<bool>())
            {
                ...
                if (stormT != null)
                    LeagueSharp.Common.Utility.DelayAction.Add(200, () => R.Cast(stormT.ServerPosition));
            }
        ...
        private static void OnInterruptableTarget(AIHeroClient unit, Interrupter2.InterruptableTargetEventArgs args)
        {
