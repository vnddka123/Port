...
namespace UnderratedAIO.Helpers
{
    public class CombatHelper
    {
        ...
        public static bool IsFacing(Obj_AI_Base source, Vector3 target, float angle = 90)
        {
            ...
            return
                (double)
                    EloBuddy.SDK.Geometry.AngleBetween(
                        EloBuddy.SDK.Geometry.Perpendicular(EloBuddy.SDK.Extensions.To2D(source.Direction)), EloBuddy.SDK.Extensions.To2D(target - source.Position)) <
                angle;
        }
        ...
        public static double GetAngle(Obj_AI_Base source, Vector3 target)
        {
            ...
            return EloBuddy.SDK.Geometry.AngleBetween(
                EloBuddy.SDK.Geometry.Perpendicular(EloBuddy.SDK.Extensions.To2D(source.Direction)), EloBuddy.SDK.Extensions.To2D(target - source.Position));
            ;
        }
