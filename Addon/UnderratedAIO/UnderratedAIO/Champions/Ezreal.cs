...
namespace UnderratedAIO.Champions
{
    internal class Ezreal
    {
        ...
        private AIHeroClient getTarget()
        {
            ...
            {
                case 0:
                    return LeagueSharp.Common.TargetSelector.GetTarget(1500, LeagueSharp.Common.TargetSelector.DamageType.Magical);
                    break;
                case 1:
                    return LeagueSharp.Common.TargetSelector.GetTarget(1500, LeagueSharp.Common.TargetSelector.DamageType.Physical);
                    break;
                default:
                    return LeagueSharp.Common.TargetSelector.GetTarget(1500, LeagueSharp.Common.TargetSelector.DamageType.Magical);
                    break;
