...
namespace UnderratedAIO.Champions
{
    internal class Udyr
    {
        ...
        private void Combo()
        {
            AIHeroClient target = LeagueSharp.Common.TargetSelector.GetTarget(600, LeagueSharp.Common.TargetSelector.DamageType.Physical);
            if (target == null)
            {
                var t2 =
            ...
            if ((target.Health > R.GetDamage(target) || player.Mana < Q.Instance.SData.Mana * 2) && isInRange)
            {
