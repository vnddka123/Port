...
namespace UnderratedAIO.Champions
{
    internal class Nocturne
    {
        ...
        private void Combo()
        {
            AIHeroClient target = LeagueSharp.Common.TargetSelector.GetTarget(GetTargetRange(), LeagueSharp.Common.TargetSelector.DamageType.Physical);
            if (target == null)
            {
                return;
            }
            ...
            var eTarget = LeagueSharp.Common.TargetSelector.GetTarget(E.Range, LeagueSharp.Common.TargetSelector.DamageType.Physical);
