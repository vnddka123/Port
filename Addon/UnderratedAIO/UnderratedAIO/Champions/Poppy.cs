...
namespace UnderratedAIO.Champions
{
    internal class Poppy
    {
        ...
        private static void Game_OnGameUpdate(EventArgs args)
        {
            ...
            AIHeroClient targetf = LeagueSharp.Common.TargetSelector.GetTarget(1000, LeagueSharp.Common.TargetSelector.DamageType.Magical);
            ...
            if (!player.IsDead)
            {
                foreach (var dashingEnemy in
                    HeroManager.Enemies.Where(
                        e =>
                            e.IsValidTargetLS() && e.Distance(player) < 1600 &&
                ...
                {
                    var nextpos = LeagueSharp.Common.Prediction.GetPrediction(dashingEnemy, 0.1f).UnitPosition;
