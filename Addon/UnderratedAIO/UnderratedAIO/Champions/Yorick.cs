...
namespace UnderratedAIO.Champions
{
    internal class Yorick
    {
        ...
        private void Combo()
        {
            AIHeroClient target = LeagueSharp.Common.TargetSelector.GetTarget(1500, LeagueSharp.Common.TargetSelector.DamageType.Physical);
            if (target == null)
            {
                return;
            }
                ...
                var ally =
                    HeroManager.Allies.Where(
                        i =>
                            ...
                            !config.Item("ulty" + i.BaseSkinName).GetValue<bool>() && i.CountEnemiesInRange(750) > 0)
