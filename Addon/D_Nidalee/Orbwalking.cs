...
namespace D_Nidalee
{
    ...
    public static class Orbwalking
    {
            ...
            bool randomizeMinDistance = true)
        {
            ...
            if (position.LSDistance(Player.ServerPosition) < Player.BoundingRadius)
            {
            ...
            if (position.LSDistance(Player.ServerPosition) > maximumDistance)
            {
            ...
            if (Player.LSDistance(position) > 350f)
            {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.Add("Farm", new KeyBind("Mixed", false, KeyBind.BindTypes.HoldActive, 'V'));
                _config.Add("Freeze", new KeyBind("Freeze", false, KeyBind.BindTypes.HoldActive, 'A'));
                ...
                _config.Add("Burst", new KeyBind("Burst", false, KeyBind.BindTypes.HoldActive, 32));
            ...
            public virtual AttackableUnit GetTarget()
            {
                    ...
                    mode == OrbwalkingMode.Freeze)
                {
                    ...
                    foreach (var minion in MinionList)
                    {
                        ...
                        {
                            if (minion.Health <= 1 || minion.Health <= 2 && Player.LSDistance(minion) >= 300)
                            {
                                return minion;
                            }
                        }
