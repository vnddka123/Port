...
namespace Syndra
{
    ...
    internal class AssassinManager
    {
        ...
        public void Initialize()
        {
            ...
            {
                LeagueSharp.Common.TargetSelector.AddToMenu(menuTargetSelector);
            }
            ...
            TargetSelector.DamageType vDefaultDamageType = TargetSelector.DamageType.Physical)
        {
            ...
            var vEnemy =
                HeroManager.Enemies.Where(e => e.IsValidTargetLS(vDefaultRange) && !e.IsZombie)
