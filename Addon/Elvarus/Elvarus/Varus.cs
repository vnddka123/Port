namespace Elvarus
{
    ...
    internal class Varus
    {
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            spells[Spells.Q].SetSkillshot(0.25f, 70f, 1650f, false, SkillshotType.SkillshotLine);
            spells[Spells.E].SetSkillshot(0.35f, 120, 1500, false, SkillshotType.SkillshotCircle);
            spells[Spells.R].SetSkillshot(0.25f, 120f, 1950f, false, SkillshotType.SkillshotLine);

            spells[Spells.Q].SetCharged("VarusQ", "VarusQ", 925, 1600, 1.2f);
        ...
        private static void Combo()
        {
            ...
            if (spells[Spells.R].IsReady() && !spells[Spells.Q].IsCharging
                && target.IsValidTargetLS(spells[Spells.R].Range) && ElVarusMenu.Menu.Item("ElVarus.Combo.R").IsActive())
            {
        ...
        private static void Items(Obj_AI_Base target)
        {
            ...
            if (ghost.IsReady() && ghost.IsOwned(Player) && target.IsValidTargetLS(spells[Spells.Q].Range) && useYoumuu)
            {
                ghost.Cast();
            }
        }
            ...
            if (ElVarusMenu.Menu.Item("ElVarus.KSSS").IsActive() && spells[Spells.Q].IsReady())
            {
                foreach (var target in
                    HeroManager.Enemies.Where(
                        enemy =>
                        enemy.IsValidTargetLS() && spells[Spells.Q].IsKillable(enemy)
        ...
        private static void OnGameUpdate(EventArgs args)
        {
            ...
            if (spells[Spells.R].IsReady() && target.IsValidTargetLS()
